...
class Coats(Clothes):
    ...
    def material_cons(self):
        return round(self.size/6.5 + self.coefficient, 2)
...
class Costumes(Clothes):
    ...
    @property
    def material_cons(self):
        return round(2 * self.size + self.coefficient, 2)


my_costume = Costumes(158)
my_coat = Coats(32)

print(my_coat.material_cons)
print(my_costume.material_cons)